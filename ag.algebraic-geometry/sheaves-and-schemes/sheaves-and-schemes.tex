...
\end{tikzcd}
	...
	\begin{proof}
		...
		It's easy to see that this map is multiplicative and additive. To show that it's actually an isomorphism, we construct the inverse: $\psi:(g/f^{n})/(h/f^{m})\mapsto (gf^{m})/(hf^n)$. \textcolor{purple}{Need details!}
	\end{proof}
